...
class userdetailss extends StatefulWidget {
  const userdetailss({Key? key}) : super(key: key);

  @override
  State<userdetailss> createState() => _userdetailssState();
}

class _userdetailssState extends State<userdetailss> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text('Occupation: User', style: TextStyle(color: Colors.black),)
            ],
          ),
          SizedBox(height: 10,),
          Row(
